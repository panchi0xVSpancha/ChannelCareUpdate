											...
											<tbody>
												...
												foreach ($get_history as $row) {
													...
													<tr>
														...
														<td><a href="patient-view-appointment-detail.php?aptid=<?php echo htmlentities($row['appointment_id']); ?>&&full_name=<?php echo htmlentities($full_name); ?>&&specialization=<?php echo htmlentities($specialization); ?>&&doc_phone=<?php echo htmlentities($doc_phone); ?>&&doc_email=<?php echo htmlentities($doc_email); ?>&&address=<?php echo htmlentities($address); ?>"
